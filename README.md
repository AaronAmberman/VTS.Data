...
## Generated Warnings
In the debug console you will notice some data warnings that come from the API as well. There seems to be some bugs in VTOL VR when it comes to verifying the data being written to the VTS file. So I have added some validation checks to the code and spit out warnings. The types of warnings...
